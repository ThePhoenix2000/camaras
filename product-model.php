...
$url = "http://api.tvc.mx/products?perPage=3000&withInventory=simple&withPrice&withMedia";
...
curl_close($curl);
  ...
  $item_aumento = $item->data;
                for ($i=0; $i <count($item_aumento); $i++) { 
                 if ($item_aumento[$i]->brand == $marcas) {
                ...
                <li>
                  <figure>
                    <a class="aa-product-img" href="#">
                      ...
                      $res_img_url = "http://api.tvc.mx/{$item_aumento[$i]->media->main_image}";
            ...
            <div class="aa-product-catg-pagination">
              <nav>
                <ul class="pagination">
                  ...
                  <li><a href="./product-model.php?pagina=<?php echo $cargar[$i]; ?>&num=<?php echo $i;?>"><?php  echo $i; ?></a></li>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <?php $res_img =$item_aumento[$i]->media->main_image;
                                 ...
                                 if ($res_img!="") {
                                     # code...
                                     echo "<img src='$res_img_url' width='50' height='50'/> &nbsp;&nbsp;&nbsp;&nbsp;";

           
                                 }else{
                                    echo "<img src='$not_img' width='40' height='40'/> &nbsp;&nbsp;&nbsp;&nbsp;";
